...
function App() {
  ...
  const handleSingleSearch = async (e) => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/api/search-competitors-advanced`, {
        method: 'POST',
    ...
    return (
      <div className="min-h-screen" style={{background: '#0a0a0a'}}>
        ...
        <header className="corporate-header" style={{background: '#0a0a0a'}}>
                ...
                <h1 className="text-4xl text-white font-bold" style={{color: '#ffffff'}}>Geonome</h1>
                <p className="text-white text-opacity-90 mt-2 font-medium italic">"Built on maps backed by insight"</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-16">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-5xl font-bold text-white mb-8 leading-tight">
                Pick the perfect business location with <span className="text-blue-400">data</span>, not guesswork
              </h2>
              <p className="text-xl text-white text-opacity-80 mb-12 leading-relaxed">
                Our tool gives real-time insights on competitors, rent, and spending trends—so you launch smarter, faster, and with confidence.
              </p>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="corporate-card p-8 text-center">
              ...
              <p className="text-gray-600">
                Get comprehensive insights on competitor density, market saturation, and local business trends with live data updates.
              </p>
            </div>
            ...
            <div className="corporate-card p-8 text-center">
              ...
              <p className="text-gray-600">
                Make informed decisions with detailed demographics, spending patterns, and financial projections for any location.
              </p>
            </div>
            ...
            <div className="corporate-card p-8 text-center">
              ...
              />
              <div className="corporate-icon mx-auto mb-4">💼</div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">Business Success</h3>
              <p className="text-gray-600">
                Launch with confidence using our comprehensive location intelligence platform trusted by entrepreneurs worldwide.
              </p>
            </div>
          </div>
          ...
          <div className="corporate-card p-12 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join thousands of entrepreneurs who have successfully launched their businesses using our platform.
            </p>
            <button
              onClick={() => setShowLandingPage(false)}
              className="corporate-btn text-lg px-12 py-4 transform hover:scale-105"
      ...
      <header className="corporate-header" style={{background: '#0a0a0a'}}>
        <div className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h1 className="text-4xl text-white font-bold" style={{color: '#ffffff'}}>Geonome</h1>
              <p className="text-white text-opacity-90 mt-2 font-medium">Professional Location Intelligence Platform</p>
            </div>
          </div>
          <div className="hidden md:flex items-center space-x-8 text-white text-sm">
            <div className="flex items-center">
              <div className="corporate-icon-sm mr-3" style={{background: 'rgba(255, 255, 255, 0.2)', color: 'white', border: '1px solid rgba(255, 255, 255, 0.3)'}}>📊</div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <div className="corporate-card p-6 sticky top-8">
              ...
              <form onSubmit={handleSingleSearch} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSingleLocation({...singleLocation, businessType: e.target.value})}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setSingleLocation({...singleLocation, location: e.target.value})}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setSingleLocation({...singleLocation, radius: Number(e.target.value)})}
              ...
              {error && (
                <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-center">
                    <div className="corporate-icon-sm corporate-icon-error mr-2">⚠️</div>
          ...
          <div className="xl:col-span-2">
            <div className="space-y-6">
              ...
              <div className="corporate-card p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <h2 className="corporate-title text-xl">Interactive Location Map</h2>
                  </div>
                  {singleAnalysis && (
                    <div className="flex items-center text-sm text-gray-600">
                      <div className="corporate-icon-sm corporate-icon-success mr-2">✓</div>
                      Analysis Complete
                    </div>
                  )}
                </div>
              ...
              {/* Competitors List */}
              {singleAnalysis && singleAnalysis.competitors && singleAnalysis.competitors.length > 0 && (
                <div className="corporate-card p-6 animate-slide-up">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center">
                      <div className="corporate-icon">🏢</div>
                      <h3 className="corporate-title text-lg">Nearby Competitors</h3>
                    </div>
                    <div className="flex items-center bg-blue-50 px-3 py-1 rounded-full">
                      <span className="text-blue-600 font-semibold text-sm">{singleAnalysis.competitors.length} Found</span>
                    </div>
                  </div>
                      ...
                      <div key={index} className="competitor-card">
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="corporate-title text-base truncate">{competitor.name}</h4>
                            ...
                            <div className="flex items-center mt-3 space-x-4">
                              {competitor.rating && (
                                <div className="flex items-center bg-yellow-50 px-2 py-1 rounded-md">
                                  ...
                                  <span className="text-sm font-medium text-yellow-700">{competitor.rating}</span>
                                </div>
                              )}
              ...
              <div className="space-y-4 sticky top-8 animate-slide-up">
                ...
                <div className="corporate-sidebar-card p-4">
                  ...
                  <div className="space-y-3">
                    <div className="metric-card">
                      <div className="metric-value text-blue-600">{singleAnalysis.competitor_count}</div>
                      <div className="metric-label">Total Competitors</div>
                    </div>
                    <div className="metric-card">
                      <div className={`metric-value ${getSaturationColor(singleAnalysis.saturation_score)}`}>
                ...
                <div className="corporate-sidebar-card p-4">
                  ...
                  <div className="space-y-3">
                    <div className="data-row">
                      ...
                      <span className="data-value">{singleAnalysis.demographics?.estimated_population?.toLocaleString() || 'N/A'}</span>
                    </div>
                    {singleAnalysis.demographics?.median_household_income && (
                      <div className="data-row">
                        ...
                        <span className="data-value text-green-600">{formatCurrency(singleAnalysis.demographics.median_household_income)}</span>
                      </div>
                    )}
                    {singleAnalysis.demographics?.median_age && (
                      <div className="data-row">
                        ...
                        <span className="data-value">{Number(singleAnalysis.demographics.median_age).toFixed(1)} yrs</span>
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="data-row">
                      ...
                      <span className="data-value text-green-600">
                        {formatCurrency(singleAnalysis.break_even_analysis.estimated_monthly_revenue)}
                      </span>
                    </div>
                    <div className="data-row">
                      <span className="data-label flex items-center">
                      ...
                      <span className="data-value text-red-600">
                        {formatCurrency(singleAnalysis.break_even_analysis.monthly_costs)}
                      </span>
                    </div>
                    <div className="data-row">
                      <span className="data-label flex items-center">
                    ...
                    <div className="data-row">
                      ...
                      <span className={`data-value ${
                        (singleAnalysis.break_even_analysis.roi_percentage || 0) > 20
                ...
                {singleAnalysis.demographics?.air_quality_index && (
                  <div className="corporate-sidebar-card p-4">
                    ...
                    <div className="metric-card">
                      <div className={`metric-value ${getAQIColor(singleAnalysis.demographics.air_quality_index)}`}>
                        {singleAnalysis.demographics.air_quality_index}
                      </div>
                      <div className={`text-xs font-medium ${getAQIColor(singleAnalysis.demographics.air_quality_index)}`}>
        ...
        {singleAnalysis && (
          <div className="mt-8 animate-slide-up">
            <div className="corporate-card p-6 mb-6">
              <div className="flex items-center mb-6">
                <div className="corporate-icon">📊</div>
                <h2 className="corporate-title text-2xl">Comprehensive Business Intelligence</h2>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="corporate-sidebar-card p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="corporate-title text-lg">Detailed Demographics</h3>
                  </div>
                  {singleAnalysis.demographics?.zip_code && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      <div className="flex items-center">
                        <div className="corporate-icon-sm mr-2">📍</div>
                        <h4 className="font-semibold text-blue-900">ZIP Code: {singleAnalysis.demographics.zip_code}</h4>
                      </div>
                    </div>
                  )}
                  <div className="space-y-3">
                    <div className="data-row">
                      ...
                      <span className="data-value">{singleAnalysis.demographics?.population_density || 'N/A'} /km²</span>
                    </div>
                    {singleAnalysis.demographics?.per_capita_income && (
                      <div className="data-row">
                        <span className="data-label">Per Capita Income:</span>
                        <span className="data-value">{formatCurrency(singleAnalysis.demographics.per_capita_income)}</span>
                      </div>
                    )}
                    {singleAnalysis.demographics?.education_bachelor_plus && (
                      <div className="data-row">
                        <span className="data-label">College Educated:</span>
                        <span className="data-value">{Number(singleAnalysis.demographics.education_bachelor_plus).toFixed(1)}%</span>
                      </div>
                    )}
                    {singleAnalysis.demographics?.unemployment_rate !== undefined && singleAnalysis.demographics.unemployment_rate !== null && (
                      <div className="data-row">
                        <span className="data-label">Unemployment:</span>
                        <span className={`data-value ${Number(singleAnalysis.demographics.unemployment_rate) < 5 ? 'text-green-600' : 'text-red-600'}`}>
                          {Number(singleAnalysis.demographics.unemployment_rate).toFixed(1)}%
                        </span>
                      </div>
                    )}
                    {singleAnalysis.demographics?.poverty_rate !== undefined && singleAnalysis.demographics.poverty_rate !== null && (
                      <div className="data-row">
                        <span className="data-label">Poverty Rate:</span>
                        <span className={`data-value ${Number(singleAnalysis.demographics.poverty_rate) < 15 ? 'text-green-600' : 'text-yellow-600'}`}>
                          {Number(singleAnalysis.demographics.poverty_rate).toFixed(1)}%
                        </span>
                      </div>
                    )}
                    <div className="data-row">
                      <span className="data-label">Foot Traffic:</span>
                      <span className="data-value">{singleAnalysis.foot_traffic_score || 'N/A'}/100</span>
                    </div>
                  </div>
                </div>

                {/* Consumer Spending Analysis */}
                {(singleAnalysis.demographics?.average_spending_retail || singleAnalysis.demographics?.consumer_spending_index || singleAnalysis.demographics?.spending_categories) && (
                  <div className="corporate-sidebar-card p-6">
                    <div className="flex items-center mb-4">
                      <div className="corporate-icon-sm mr-3">💳</div>
                      <h3 className="corporate-title text-lg">Consumer Spending</h3>
                    </div>
                    <div className="space-y-3">
                      {singleAnalysis.demographics?.average_spending_retail && (
                        <div className="data-row">
                          ...
                          <span className="data-value text-green-600">
                            {formatCurrency(singleAnalysis.demographics.average_spending_retail)}
                          </span>
                        </div>
                      )}
                      {singleAnalysis.demographics?.consumer_spending_index && (
                        <div className="data-row">
                          ...
                          <span className={`data-value ${
                            Number(singleAnalysis.demographics.consumer_spending_index) > 100 ? 'text-green-600' :
                            Number(singleAnalysis.demographics.consumer_spending_index) > 80 ? 'text-yellow-600' : 'text-red-600'
                          }`}>
                            {Number(singleAnalysis.demographics.consumer_spending_index).toFixed(0)}
                          </span>
                        </div>
                      )}
                      {singleAnalysis.demographics?.foot_traffic_multiplier && (
                        <div className="data-row">
                          <span className="data-label">Traffic Multiplier:</span>
                          <span className="data-value text-blue-600">
                            {Number(singleAnalysis.demographics.foot_traffic_multiplier).toFixed(2)}x
                          </span>
                        </div>
                      )}
                    </div>
                    ...
                    {/* Spending Categories */}
                    {singleAnalysis.demographics?.spending_categories && typeof singleAnalysis.demographics.spending_categories === 'object' && (
                      <div className="mt-4 p-4 bg-gray-50 rounded-lg border">
                        <h4 className="font-semibold text-gray-800 mb-3 text-sm flex items-center">
                          <span className="mr-2">🛍️</span>Top Spending Categories
                        </h4>
                        <div className="space-y-2">
                          {Object.entries(singleAnalysis.demographics.spending_categories).slice(0, 4).map(([category, amount]) => (
                ...
                {/* Housing & Economic */}
                {(singleAnalysis.demographics?.average_home_value || singleAnalysis.demographics?.rent_burden_percentage || singleAnalysis.demographics?.commute_time_minutes) && (
                  <div className="corporate-sidebar-card p-6">
                    <div className="flex items-center mb-4">
                      <div className="corporate-icon-sm mr-3">🏠</div>
                      <h3 className="corporate-title text-lg">Housing & Economy</h3>
                    </div>
                    <div className="space-y-3">
                      {singleAnalysis.demographics?.average_home_value && (
                        <div className="data-row">
                          ...
                          <span className="data-value text-blue-600">
                            {formatCurrency(singleAnalysis.demographics.average_home_value)}
                          </span>
                        </div>
                      )}
                      {singleAnalysis.demographics?.rent_burden_percentage && (
                        <div className="data-row">
                          ...
                          <span className={`data-value ${
                            Number(singleAnalysis.demographics.rent_burden_percentage) > 30 ? 'text-red-600' : 'text-green-600'
                          }`}>
                            {Number(singleAnalysis.demographics.rent_burden_percentage).toFixed(1)}%
                          </span>
                        </div>
                      )}
                      {singleAnalysis.demographics?.commute_time_minutes && (
                        <div className="data-row">
                          ...
                          <span className="data-value">
                            {Number(singleAnalysis.demographics.commute_time_minutes).toFixed(0)} min
                          </span>
                        </div>
                      )}
                    </div>
              ...
              {/* Income Distribution */}
              {singleAnalysis.demographics?.household_income_distribution && typeof singleAnalysis.demographics.household_income_distribution === 'object' && (
                <div className="mt-8 corporate-sidebar-card p-6">
                  <div className="flex items-center mb-6">
                    <div className="corporate-icon-sm mr-3">📊</div>
                    <h3 className="corporate-title text-lg">Household Income Distribution</h3>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.entries(singleAnalysis.demographics.household_income_distribution).slice(0, 8).map(([bracket, data]) => (
                      <div key={bracket} className="text-center p-3 bg-gray-50 rounded-lg border">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                          <div
                            ...
                            style={{width: `${Math.min((data?.percentage || 0) * 3, 100)}%`}}
                          ></div>
                        </div>
                        <div className="font-bold text-sm text-blue-600">{(data?.percentage || 0).toFixed(1)}%</div>
                      </div>
                    ))}
                  </div>
                </div>
